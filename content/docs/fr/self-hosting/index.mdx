...
description: Déployez Zaron sur votre propre infrastructure
---

import { Card, Cards } from 'fumadocs-ui/components/card'
import { Callout } from 'fumadocs-ui/components/callout'

Déployez Zaron sur votre propre infrastructure avec Docker ou Kubernetes.
...
|-----------|------|-------------|
| zaronsdk | 3000 | Application principale |
