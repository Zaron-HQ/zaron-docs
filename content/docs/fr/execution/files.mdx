...
Zaron facilite le travail avec les fichiers tout au long de vos workflows. Les blocs peuvent recevoir des fichiers, les traiter et les transmettre à d'autres blocs de manière transparente.
...
<Tabs items={['Base64', 'URL']}>
  <Tab value="Base64">
    ...
    ```bash
    curl -X POST "https://zaron.dev/api/workflows/YOUR_WORKFLOW_ID/execute" \
