...
description: Essential actions for navigating and using the Zaron workflow editor
---

import { Callout } from 'fumadocs-ui/components/callout'
import { ActionImage, ActionVideo } from '@/components/ui/action-media'

A quick lookup for everyday actions in the Zaron workflow editor. For keyboard shortcuts, see [Keyboard Shortcuts](/keyboard-shortcuts).
