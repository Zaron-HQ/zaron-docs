...
The A2A (Agent-to-Agent) protocol enables Zaron to interact with external AI agents and systems that implement A2A-compatible APIs. With A2A, you can connect Zaron’s automations and workflows to remote agents—such as LLM-powered bots, microservices, and other AI-based tools—using a standardized messaging format.

Using the A2A tools in Zaron, you can:
...
- **Integrate Third-Party AI and Automation**: Leverage external A2A-compatible services as part of your Zaron workflows.

These features allow you to build advanced workflows that combine Zaron’s native capabilities with the intelligence and automation of external AIs or custom agents. To use A2A integrations, you’ll need the external agent’s endpoint URL and, if required, an API key or credentials.
{/* MANUAL-CONTENT-END */}
