...
With the Okta integration in Zaron, you can:
...
In Zaron, the Okta integration enables your agents to automate identity management tasks as part of their workflows. This allows for scenarios such as onboarding new employees, offboarding departing users, managing group-based access, auditing user status, and responding to security events by suspending or deactivating accounts.

## Need Help?

If you encounter issues with the Okta integration, contact us at [help@zaron.dev](mailto:help@zaron.dev)
{/* MANUAL-CONTENT-END */}
