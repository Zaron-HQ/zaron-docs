...
2. Zaron validates the request and maps parameters to workflow inputs
...
<FAQ items={[
  ...
  { question: "What MCP protocol does Zaron implement?", answer: "Zaron implements the standard MCP protocol using the official @modelcontextprotocol/sdk types, supporting JSON-RPC 2.0 messages including tools/list and tools/call methods. It handles both requests and notifications per the MCP specification." },
