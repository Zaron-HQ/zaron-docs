...
Webhooks allow external services to trigger workflow execution by sending HTTP requests to your workflow. Zaron supports two approaches for webhook-based triggers.
