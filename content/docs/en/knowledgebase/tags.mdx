...
<FAQ items={[
  ...
  { question: "What embedding model does Zaron use for knowledge base search?", answer: "Zaron uses OpenAI's text-embedding-3-small model with 1536 dimensions for generating document embeddings and performing vector similarity search." },
]} />
