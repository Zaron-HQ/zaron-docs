...
Simply upload your documents to get started. Zaron automatically processes them in the background, extracting text, creating embeddings, and breaking them into searchable chunks.
...
For PDF documents, Zaron offers enhanced processing capabilities:
...
Zaron uses vector search powered by [pgvector](https://github.com/pgvector/pgvector) to understand the meaning and context of your content:
...
<FAQ items={[
  ...
  { question: "Does it support scanned PDFs?", answer: "Yes. When configured with Azure or Mistral OCR, Zaron can extract text from image-based and scanned PDF documents." },
