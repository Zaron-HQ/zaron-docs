...
Go to the Zaron dashboard and navigate to **Settings → Zaron Keys**, then click **Create**. See [Authentication](/api-reference/authentication) for details on key types.
</Step>
