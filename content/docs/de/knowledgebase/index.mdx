...
Laden Sie einfach Ihre Dokumente hoch, um zu beginnen. Zaron verarbeitet sie automatisch im Hintergrund, extrahiert Text, erstellt Embeddings und teilt sie in durchsuchbare Chunks auf.
...
Für PDF-Dokumente bietet Zaron erweiterte Verarbeitungsfunktionen:
...
Zaron verwendet Vektorsuche, die von [pgvector](https://github.com/pgvector/pgvector) unterstützt wird, um die Bedeutung und den Kontext Ihrer Inhalte zu verstehen:
