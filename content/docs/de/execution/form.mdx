...
- Per Direktlink geteilt werden kann (z. B. `https://zaron.dev/form/my-survey`)
...
3. Konfigurieren Sie:
   - **URL**: Eindeutige Kennung (z. B. `contact-form` → `zaron.dev/form/contact-form`)
...
**Formular lädt nicht im Iframe** - Überprüfen Sie, ob die CSP Ihrer Website Iframes von `zaron.dev` erlaubt.
