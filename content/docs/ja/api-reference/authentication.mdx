...
To access the Zaron API, you need an API key. Zaron supports two types of API keys — **personal keys** and **workspace keys** — each with different billing and access behaviors.
...
To generate a key, open the Zaron dashboard and navigate to **Settings**, then go to **Zaron Keys** and click **Create**.
...
- Keys use the `sk-Zaron-` prefix and are encrypted at rest
