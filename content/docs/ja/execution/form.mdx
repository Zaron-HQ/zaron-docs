...
- 直接リンクで共有(例: `https://zaron.dev/form/my-survey`)
...
2. **Form**タブを選択します
3. 設定:
   - **URL**: 一意の識別子(例: `contact-form` → `zaron.dev/form/contact-form`)
   - **Title**: フォームの見出し
...
**iframeでフォームが読み込まれない** - サイトのCSPが`zaron.dev`からのiframeを許可しているか確認してください。
