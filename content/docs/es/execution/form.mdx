...
- Compartido mediante un enlace directo (ej., `https://zaron.dev/form/my-survey`)
...
3. Configura:
   - **URL**: Identificador único (ej., `contact-form` → `zaron.dev/form/contact-form`)
...
**El formulario no se carga en el iframe** - Verifica que el CSP de tu sitio permita iframes desde `zaron.dev`.
