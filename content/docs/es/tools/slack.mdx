...
<iframe
  ...
  title="Integración de Slack con Zaron"
  frameBorder="0"
...
- **Automatiza notificaciones de agentes**: Envía actualizaciones en tiempo real desde tus agentes Zaron a cualquier canal de Slack
- **Crea endpoints de webhook**: Configura bots de Slack como webhooks para activar flujos de trabajo de Zaron desde actividades de Slack
...
En Zaron, la integración con Slack permite a tus agentes interactuar programáticamente con Slack con capacidades completas de gestión de mensajes como parte de sus flujos de trabajo:
