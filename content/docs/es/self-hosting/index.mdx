...
description: Despliega Zaron en tu propia infraestructura
---

import { Card, Cards } from 'fumadocs-ui/components/card'
import { Callout } from 'fumadocs-ui/components/callout'

Despliega Zaron en tu propia infraestructura con Docker o Kubernetes.
...
|-----------|------|-------------|
| zaronsdk | 3000 | Aplicación principal |
