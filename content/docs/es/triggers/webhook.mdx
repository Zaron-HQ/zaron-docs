...
Los webhooks permiten que servicios externos activen la ejecución de flujos de trabajo mediante el envío de solicitudes HTTP a tu flujo de trabajo. Zaron admite dos enfoques para los disparadores basados en webhooks.
