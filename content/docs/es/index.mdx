...
# Documentación de Zaron

Bienvenido a Zaron, un constructor visual de flujos de trabajo para aplicaciones de IA. Crea potentes agentes de IA, flujos de trabajo de automatización y canales de procesamiento de datos conectando bloques en un lienzo.

## Inicio rápido

<Cards>
  <Card title="Introducción" href="/introduction">
    Aprende lo que puedes construir con Zaron
  </Card>
...
<Cards>
  ...
  <Card title="SDKs" href="/sdks">
    Integra Zaron en tus aplicaciones
  </Card>
</Cards>